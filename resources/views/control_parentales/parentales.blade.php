...
<body>
    <div class="container">
        <h1>CONTROLES PARENTALES</h1>

        <form action="{{route ('parental.store')}} " method="post" enctype="multipart/form-data">
            @csrf
            <label>
                <input type="text" name="pin_control_parental" placeholder="pin del acceso">
            </label>
